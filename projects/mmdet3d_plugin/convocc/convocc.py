...
class ConvOcc(BaseDetector):
    def __init__(self,
        ...
        # 是否开启 image feat encoder
        self.use_img_feat_encoder = use_img_feat_encoder
        self.encoder_layers = len(multi_scale_id)
        if self.use_img_feat_encoder:  # 开启
    ...
    def extract_feat(self, img, img_metas=None):
        ...
        if self.use_img_feat_encoder:  # 是否开启 image feat encoder
            ...
            mlvl_feats = mlvl_feats_[::-1]  # (24,64,64/i,176/i),i=1,2,4
        else:
            mlvl_feats = mlvl_feats[:3][::-1]
