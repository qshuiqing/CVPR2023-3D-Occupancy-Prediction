...
class ConvOccLSVTv2(BaseModule):
    def __init__(self,
                 n_voxels,
                 voxel_size,
                 in_channels,
        ...
        super(ConvOccLSVTv2, self).__init__()
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        # Extract voxel feat.
        mlvl_volumes = self.extract_voxel_feat(mlvl_feats, img_metas)
    ...
    def extract_voxel_feat(self, mlvl_feats, img_metas):
